    ...
    public function store(Request $request) {
        ...
        for ($i = 0; $i<7; $i++)
        {
            if($morning_start[$i] > $morning_end[$i]) {
                $errors[] = 'Inconsistencia en los horarios de atención de la mañana en día '. $this->days[$i].'.';
            }
            if($afternoon_start[$i] > $afternoon_end[$i]) {
                $errors[] = 'Inconsistencia en los horarios de atención de la tarde en día '. $this->days[$i].'.';
            }
