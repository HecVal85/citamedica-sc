            ...
            @foreach ($pendingAppointments as $cita)
                <tr>
                    ...
                    <td>
                        ...
                        @if ($role == 'admin')
                            <a href=" {{ url('/miscitas/'.$cita->id) }}" class="btn btn-small btn-info" title="Ver cita" >
                                <i class="ni far fa-eye"></i> </a>
                        @endif
                        ...
                        @if ($role == 'doctor' || $role == 'admin' )
                            <form action=" {{ url('/miscitas/'.$cita->id.'/confirm') }} " method="POST" class="d-inline-block">
                                ...
                                <button type="submit" class="btn btn-small btn-success" title="Confirmar cita" >
                        ...
                        <form action=" {{ url('/miscitas/'.$cita->id.'/cancel') }} " method="POST" class="d-inline-block">
                            ...
                            <button type="submit" class="btn btn-small btn-danger" title="Cancelar cita" >
