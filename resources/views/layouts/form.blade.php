                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6">
                            <h1 class="text-white"> @yield('title' , 'Bienvenido/a!!') </h1>
                            <p class="text-lead text-light"> Este es el sistema de Citas Médicas de la Clínica Sagrado Corazón de Jesús. </p>
                        </div>
                    </div>
                </div>
            </div>
